...
export default function ProfileScreen() {
  ...
  const fetchStudentData = async () => {
    try {
      ...
      // Query the student table using the email
        ...
        <View style={styles.content}>
          <View style={styles.blackContainer}>
            <View style={styles.profileContainer}>
              <ThemedText style={styles.nameText}>{studentData?.name || 'Student Name'}</ThemedText>
              <View style={styles.infoRow}>
                <Ionicons name="school" size={20} color="white" />
                <ThemedText style={styles.infoText}>ID: {studentData?.id}</ThemedText>
              </View>
              <View style={styles.infoRow}>
                <Ionicons name="document-text" size={20} color="white" />
                <ThemedText style={styles.infoText}>Roll No: {studentData?.rollno}</ThemedText>
              </View>
              <View style={styles.infoRow}>
                <Ionicons name="business" size={20} color="white" />
                <ThemedText style={styles.infoText}>Department: {studentData?.dept}</ThemedText>
              </View>
              <View style={styles.infoRow}>
                <Ionicons name="calendar" size={20} color="white" />
                <ThemedText style={styles.infoText}>Semester: {studentData?.sem}</ThemedText>
              </View>
              <View style={styles.infoRow}>
                <Ionicons name="mail" size={20} color="white" />
                <ThemedText style={styles.infoText}>Email: {studentData?.email}</ThemedText>
              </View>
