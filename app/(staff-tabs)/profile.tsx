        ...
        <View style={styles.content}>
          <View style={styles.blackContainer}>
            <View style={styles.profileContainer}>
              <ThemedText style={styles.nameText}>{staffData?.name || 'Staff Name'}</ThemedText>

              <View style={styles.infoRow}>
                <Ionicons name="business" size={20} color="white" />
                <ThemedText style={styles.infoText}>Department: {staffData?.section}</ThemedText>
              </View>

              <View style={styles.infoRow}>
                <Ionicons name="mail" size={20} color="white" />
                <ThemedText style={styles.infoText}>Email: {staffData?.email}</ThemedText>
              </View>
